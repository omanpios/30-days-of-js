...
const categorizeCountries = countries.filter(country => country.name.includes('stan'))
console.log(categorizeCountries)

const countriesStartWithC = countries.filter(country => country.name.startsWith('C')).length
console.log({ letter: 'C', countriesStartWithC })

function firstTenCountries() {
    const first = []
    for (i = 0; i < 10; i++) {
...
function lastTenCountries() {
    const last = []
    for (i = countries.length - 1; i > countries.length - 11; i--) {
        last.push(countries[i])
    }
    console.log(last)
}
lastTenCountries()
